 ...
 * @author  Gary Jones
 */
class EJO_Widget_Template_Loader
{
	/**
	 * Prefix for filter names.
	 */
	protected $filter_prefix = 'ejo_';
	 ...
	 */
	protected $theme_template_directory = 'widget';
	...
	{
		$theme_template_directory = trailingslashit( $this->theme_template_directory );

		//* Prioritized order of template locations
		$file_paths = array();

		//* Start by setting theme location high in order
		$file_paths[10] = trailingslashit( get_template_directory() ) . $theme_template_directory;
		$file_paths[11] = trailingslashit( get_template_directory() );

		//* Set child theme location first if active
		if ( is_child_theme() ) {
			$file_paths[1] = trailingslashit( get_stylesheet_directory() ) . $theme_template_directory;
			$file_paths[2] = trailingslashit( get_stylesheet_directory() );
		}
