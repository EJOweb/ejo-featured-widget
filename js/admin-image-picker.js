jQuery(document).ready(function($){
	...
	$('body').on('click', '.ejo-image-picker .picker-button, .ejo-image-picker .image-container img', function(e)
	{
		e.preventDefault();

		var container = $(this).closest('.ejo-image-picker');
	...
	$('body').on('click', '.ejo-image-picker .remove-button', function(e)
	{
		e.preventDefault();
